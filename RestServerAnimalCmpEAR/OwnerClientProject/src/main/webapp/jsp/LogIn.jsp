...
<body>
	...
	<main>
		...
		<div class="form-container">
			...
			%>
			<form id="loginForm" class="petOwnerForm"
				action="${pageContext.request.contextPath}/LoginServlet"
				method="post">
				<label for="ownerID">Owner ID</label> <input type="text"
					id="ownerID" name="ownerID" required><br> <br> <label
					for="phone">Phone</label> <input type="text" id="phone"
					name="phone" required><br> <br> <label
					for="email">Email (optional)</label> <input type="email" id="email"
					name="email"><br> <br>
				<button type="submit" id="submitBtn">Log In</button>
				<p style="color: white; text-align: center; margin-top: 20px;">
					Don't have an account? <a href="home.jsp" style="color: #ccdbc8;">Sign
						up here</a>
				</p>
			</form>
			<p style="margin-bottom: 100px;"></p>
