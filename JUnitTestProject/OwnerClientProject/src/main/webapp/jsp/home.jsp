...
<body>
	...
	<main>
		...
		<h4>play with us</h4>
		<img class="logo3"
			src="${pageContext.request.contextPath}/images/catpic.png" alt="Logo">
		<img class="logo2"
			src="${pageContext.request.contextPath}/images/frontpic2.png"
			alt="Logo">
	...
	<div class="form-container">
		<form id="ownerPetForm" action="/OwnerClientProject/TestServlet"
			method="post">
			<label for="ownerFirstName">First Name</label> <input type="text"
				id="ownerFirstName" name="ownerFirstName" required><br>
			<br> <label for="ownerLastName">Last Name</label> <input
				type="text" id="ownerLastName" name="ownerLastName" required><br>
			<br> <label for="phone">Phone</label> <input type="text"
				...
				for="petName">Name</label> <input type="text" id="petName"
				name="petName" required><br> <br> <label
				for="species">Species</label> <input type="text" id="species"
				name="species" required><br> <br>
